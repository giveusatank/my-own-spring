...
(function () {
    ...
    var currSubject = '语文';
    // 学科分析
    var subAnalysisCharts = echarts.init(
        document.getElementById('box')
    );
    var subAnalysisOptions;
    var subAnalysisRes = [
        {name: '语文', value: 2000, selected: true},
        {name: '数学', value: 130},
        {name: '英语', value: 13},
        {name: '体育', value: 1600},
        {name: '劳动', value: 197},
        ...
        xAxis: [
            {
                ...
                data: subAnalysisRes.map(item => item.name)
            }
        ],
        yAxis: {
            type: 'value',
    ...
    mychart.setOption(subAnalysisOptions4); // top10



    var top10Charts = echarts.init(document.getElementById('box'));
    ...
    mychart.setOption(userDistributionChartsOptions); // events
